...
<div class="container">
    ...
    <div class="m-3">
        ...
        <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#newWorkExperience"><i
                class="fa fa-plus" aria-hidden="true"></i></button>
        <button type="button" class="btn btn-outline-secondary"  data-toggle="modal" data-target="#newWorkExperiencelist"><i class="fa fa-list" aria-hidden="true"></i></button>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {{EducationdetailsController::educationeview($profile[0]->profile_id)}}
...
<div class="modal fade" id="newWorkExperiencelist">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table class="table table-striped">
                    ...
                    ->select('*')
                    ->where('education_profile_id',$profile[0]->profile_id)
                    ...
                    ->get();
                        ...
                        <tr>
                            <td>{{  $key + 1}}</td>
                            <td>{{Carbon::parse($row->time_period_start)->format('Y')}}</td>
                            <td>{{$row->title_of_education}}</td>
                            <td><i class="fa fa-trash" aria-hidden="true" data-toggle="modal" data-target="#delet{{$row->education_center_id}}"></i></td>
                        </tr>



                        <!-- The Modal -->
       <div class="modal fade" id="delet{{$row->education_center_id}}">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body">
            <form action="/deleteducation" method="post">
            @csrf

            <input type="hidden" value="{{$row->education_center_id}}" name="education_center_id">
...
<!-- newWorkExperience -->
<div class="modal fade" id="newWorkExperience">
    <div class="modal-dialog  modal-xl">
        <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Add new Education Item </h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            ...
            <div class="modal-body">
                ...
                <form action="/educationadd" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="email">Education Center :</label>
                                <input type="text"
                                    class="form-control @error('education_center') is-invalid @enderror"
                                    placeholder="Education Center" id="email" name="education_center">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="email">Title of education :</label>
                                <input type="text"
                                    class="form-control @error('title_of_education') is-invalid @enderror"
                                    placeholder="Title of education" id="email" name="title_of_education">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div><h4></h4>Time period</div>
                        <div class="col">
                            <div class="form-group">
                                <label for="email">From :</label>
                                <input type="date"
                                    class="form-control @error('time_period_start') is-invalid @enderror"
                                    placeholder="From " id="email" name="time_period_start">
                                @error('time_period_start')
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="date"
                                    class="form-control @error('time_period_end') is-invalid @enderror"
                                    placeholder="To" id="email" name="time_period_end">
                                @error('time_period_end')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
                    ...
                    <input type="hidden" value="{{$profile[0]->profile_id}}" name="education_profile_id">
                    <input type="hidden" value="{{$profile[0]->profile_sug}}" name="profile_sug">
