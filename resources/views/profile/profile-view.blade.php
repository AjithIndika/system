...
@foreach ($data['profile'] as $profile[0])
    <div class="main-body">
        <div class="row">
            <div class="col-lg-3 ">
                ...
                <div class="card">
                    <div class="card-body bg-white">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#menu13" title="Work Experience">Work
                                    Experience</a>
                            </li>
                            ...
                            @if (!empty(Auth::user()->hrAdmin))
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#menu2"
                                        title="Performance eveluation">Performance evaluation </a>
                                </li>
                            @endif
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#menu11"
                                    title="Device & Support Ticket">Device & Support Ticket</a>
                            </li>


                            @if (!empty(Auth::user()->hrAdmin))
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#menu14" title="On Board">On
                                        Board</a>
                                </li>
                            @endif
