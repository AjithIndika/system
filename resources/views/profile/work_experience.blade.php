...
<div class="container">
    ...
    <div class="m-3">
        ...
        <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#WorkEx"><i class="fa fa-plus" aria-hidden="true"></i></button>
        <button type="button" class="btn btn-outline-secondary"  data-toggle="modal" data-target="#work_list"><i class="fa fa-list" aria-hidden="true"></i></button>
    </div>


    <h4 class="mb-2 text-info">Work Experience</h4>
    <div class="row mt-3">
        <div class="col-md-12">
            <div class="main-timeline7">
              {{WorkExperienceController::workexperienceview($profile[0]->profile_id)}}
            </div>
        </div>
    </div>
</div>
...
<!-- work_list -->
<div class="modal fade" id="work_list">
            ...
            <div class="modal-body">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        ->select('*')
                        ->where('work_experiences_profile_id','=',$profile[0]->profile_id)
                        ->orderBy('work_experiences_joined_date', 'DESC')->get();
                        ?>


                        @foreach ($workexpireance as $key=>$row)

                        <tr>
                            <td>{{  $key + 1}}</td>
                            <td>{{Carbon::parse($row->work_experiences_joined_date)->format('Y')}}</td>
                            <td>{{$row->work_experiences_worked_as.' /'.$row->work_experiences_organization_name}}</td>
                            <td>
                                
                                @if(!empty(Auth::user()->hrAdmin))    <i class="fa fa-trash" aria-hidden="true" data-toggle="modal" data-target="#delet{{$row->work_experiences_id}}"></i> @endif
                            </td>
                        </tr>
                        ...
                        <!-- The Modal -->
       <div class="modal fade" id="delet{{$row->work_experiences_id}}">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body">
            <form action="/deletexperience" method="post">
            @csrf

            <input type="hidden" value="{{$row->work_experiences_id}}" name="work_experiences_id">
...
<!-- newWorkExperience -->
<div class="modal fade" id="WorkEx">
    <div class="modal-dialog  modal-xl">
        <div class="modal-content">
                ...
                <form action="/workexperience" method="post">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    class="form-control @error('work_experiences_organization_name') is-invalid @enderror"
                                    placeholder="Organization Name" id="email" name="work_experiences_organization_name">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="date"
                                    class="form-control @error('work_experiences_joined_date') is-invalid @enderror"
                                    placeholder="Joined date" id="email" name="work_experiences_joined_date">
                                @error('work_experiences_joined_date')
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="email">Resigned date:</label>
                                <input type="date"
                                    class="form-control @error('work_experiences_resigned_date') is-invalid @enderror"
                                    placeholder="Resigned date" id="email" name="work_experiences_resigned_date">
                                @error('work_experiences_resigned_date')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group">
                                <label for="email">Worked as:</label>
                                <input type="text"
                                    class="form-control @error('work_experiences_worked_as') is-invalid @enderror"
                                    placeholder="Worked as:" id="email" name="work_experiences_worked_as">
                                @error('work_experiences_worked_as')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <textarea class="form-control ckeditor  @error('work_experiences_job_description') is-invalid @enderror" name="work_experiences_job_description"
                                    required rows="5" cols="3" required></textarea>
                                @error('work_experiences_job_description')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
                    ...
                    <input type="hidden" value="{{$profile[0]->profile_id}}" name="work_experiences_profile_id">
                    <input type="hidden" value="{{$profile[0]->profile_sug}}" name="profile_sug">
