                                    ...
                                    <div class="bg-success">
                                        ...
                                        <div class="col position-fixed ">
                                            ...
                                            <div class="card position-fixed div">
                                                @if (!empty($ticketDetails->tickets_profile_id))
                                                    <img class="card-img-top "
                                                        src="{{ TicketsController::profileImage($ticketDetails->tickets_profile_id, $ticketDetails->subsidiaries_id) }}"
                                                        alt="No User Image" style="width: 100px">
                                                @else
                                                @endif
