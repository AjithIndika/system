          ...
          <div class="card-body">
            ...
            <table class="table table-bordered mt-3 mb-3">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{$tecnical_officer->profile_first_name.' '.$tecnical_officer->profile_last_name }}</td>
                  <td>{{TicketsController::viewtickets_received($tecnical_officer->profile_id,$data['start_date'],$data['end_date'])}}</td>
                  <td>{{TicketsController::viewtickets_view($tecnical_officer->profile_id,$data['start_date'],$data['end_date'])}}</td>
                  <td>{{TicketsController::viewtickets_pending($tecnical_officer->profile_id,$data['start_date'],$data['end_date'])}}</td>
                  <td>{{TicketsController::viewtickets_finish($tecnical_officer->profile_id,$data['start_date'],$data['end_date'])}}</td>
                  <td class="text-center">{{TicketsController::viewtickets_total($tecnical_officer->profile_id,$data['start_date'],$data['end_date'])}}</td>
                </tr>
            ...
            <table class="table table-bordered mt-3 mb-3">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">{{TicketsController::org_viewtickets_received($subsidiaries->subsidiaries_id,$data['start_date'],$data['end_date'])}}</td>
                  <td class="text-center">{{TicketsController::org_viewtickets_view($subsidiaries->subsidiaries_id,$data['start_date'],$data['end_date'])}}</td>
                  <td class="text-center">{{TicketsController::org_viewtickets_pending($subsidiaries->subsidiaries_id,$data['start_date'],$data['end_date'])}}</td>
                  <td class="text-center">{{TicketsController::org_viewtickets_finish($subsidiaries->subsidiaries_id,$data['start_date'],$data['end_date'])}}</td>
                  <td class="text-center">{{TicketsController::org_total($subsidiaries->subsidiaries_id,$data['start_date'],$data['end_date'])}}</td>
                </tr>
