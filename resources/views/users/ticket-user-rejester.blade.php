      ...
      <div class="mask" style="background-color: rgba(0, 0, 0, 0.678);">
        <div class="d-flex justify-content-center align-items-center h-100">
          <div class="text-white">
            ...
            <a data-mdb-ripple-init class="btn btn-outline-light btn-lg" href="{{ config('app.url') }}" role="button"
            >Call to action</a
            >
          </div>
        </div>
            ...
            @endif
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        @error('profile_first_name')<div class="text-danger">{{ $message }}</div>@enderror   @error('name')<div class="text-danger">This email already exists </div>   @enderror
                    </div>
                    </div>
...
!---->
                ...
                <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            @error('profile_job_join_email')<div class="text-danger">{{ $message }}</div> @enderror   @error('email')<div class="text-danger">{{ $message }}</div> @enderror
